...
Router::scope('/clients', function($routes) {
  $routes->connect('/index', ['controller' => 'Clients', 'action' => 'index']);
  $routes->connect('/view/*', ['controller' => 'Clients', 'action' => 'view']);
  $routes->connect('/add', ['controller' => 'Clients', 'action' => 'add']);
});

Router::scope('/products', function($routes) {
  $routes->connect('/index', ['controller' => 'Products', 'action' => 'index']);
  $routes->connect('/view/*', ['controller' => 'Products', 'action' => 'view']);
