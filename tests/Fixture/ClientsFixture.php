...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'telephone' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2016-10-20 15:13:00',
            'modified' => '2016-10-20 15:13:00'
        ],
    ];
}
